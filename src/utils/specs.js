...
export const supportedSpecs = [
  {
    ...
    description:
      "Connect to any REST API Service that provides a JSON (JavaScript Object Notation) or an XML (eXtensible Markup Language) response.",
    link: "/rest-explorer",
  ...
  },
  {
    title: "RAML",
    description:
      "RESTful API Modeling Language is a YAML-based language for describing RESTful APIs. It provides all the information necessary to describe RESTful or practically RESTful API.",
