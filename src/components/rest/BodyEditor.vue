<template>
  <div style="margin-top: 12px">
    <b-form-group label="Body Type:" label-for="bodyType" label-size="sm">
      <b-form-radio-group
        buttons
    ...
    <b-form-group
      ...
      label-for="rawBody"
    >
      <b-form-textarea id="rawBody" size="sm" v-model="body.value" :rows="5">
      </b-form-textarea>
    </b-form-group>
    ...
    <div v-if="this.body.type === 'query' || this.body.type === 'form_data'">
      ...
      <b-row
        v-for="(item, index) in body.value"
        :key="index"
